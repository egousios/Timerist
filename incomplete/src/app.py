...
class Ui_Timerist(object):
    ...
    def remove(self):
        items = []
        ask = QtWidgets.QMessageBox.question(Timerist, "Are you sure ?", "Are you sure that you want to delete these document(s) permenantly, or would you like to move them to the recycle bin ?", QtWidgets.QMessageBox.Yes|QtWidgets.QMessageBox.No)
        if ask == QtWidgets.QMessageBox.Yes:
