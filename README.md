...
<p align="center">
   <em>A functional, aesthetic, customizable & easy-to-use to-do-list app with a countdown timer for each task that goes down to the very last millisecond. This project is made with dedication & love using Python & PyQt.</em>
</p>
<br>
<p align="center">
